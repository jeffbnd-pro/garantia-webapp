...
if (!isset($_SESSION['userId']) && !in_array($_GET["page"] ?? '', ['connexion','login','register','addWarrantyBdd'])) {
...
$public = [
    ...
    'register'  => __DIR__ . '/public/components/user/login_logout/register.php',
        'addWarrantyBdd'  => __DIR__ . '/public/components/dashboard/AddWarranty/addWarrantyBDD.php',
    'logout'  => __DIR__ . '/public/components/user/login_logout/logout.php',];
...
// Si page privee afficher layout.php
